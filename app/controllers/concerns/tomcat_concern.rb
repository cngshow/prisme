...
module TomcatConcern
  ...
  def get_version_hash(war:, context:, tomcat_service:)
    ...
    if war =~ /^isaac/
      ...
      version_hash[:war_id] = 'cris' + json[UuidProp::ISAAC_WAR_ID].to_s unless json[UuidProp::ISAAC_WAR_ID].to_s.empty?
      ...
      version_hash[:isaac][:war_id] = 'greg' #json['isaac_version'][UuidProp::ISAAC_WAR_ID].to_s rescue nil
