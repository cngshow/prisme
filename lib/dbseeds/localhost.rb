  ...
  LOCALHOST = [
      {
          ...
          props: [
              ...
              {key: 'cargo.remote.manager.url', value: 'https://vadev.mantech.com:4848/manager'}
          ]
      },
      {
          ...
          props: [
              {key: 'cargo.remote.username', value: 'devtest'},
              {key: 'cargo.remote.password', value: '["jK\x90\xA1\x1Fk\x87\xB6\xAB\xA3\xC5\xE7~\xBA\x1AK", "k]\x95\xD8w\x15\xFE\xD3\xC7\xDC\xAC\x9E\x1C\xD0bG"]'},
              {key: 'cargo.remote.manager.url', value: 'https://localhost:4848/manager'}
          ]
      },
      {
          service: {name: 'Nexus Artifactory', description: 'Nexus Artifactory', service_type: PrismeService::NEXUS},
          props: [
              {key: 'nexus_repository_url', value: 'https://vadev.mantech.com:8080/nexus/content/groups/everything/'},
              {key: 'nexus_publication_url', value: 'https://vadev.mantech.com:8080/nexus/content/repositories/termdata/'},
      ...
      },
      {
          ...
          props: [
              {key: 'git_repository_url', value: 'https://vadev.mantech.com:4848/git/r/db_test.git'},
      ...
      },
      {
          ...
          props: [
              {key: 'jenkins_root', value: 'https://vadev.mantech.com:8081'},
