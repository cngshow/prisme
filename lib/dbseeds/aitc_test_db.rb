  ...
  AITC_TEST = [
      {
          ...
          props: [
              ...
              {key: PrismeService::CARGO_REMOTE_URL, value: 'https://put-in-path-here:port/manager'}
          ]
      },
      {
          service: {name: 'Nexus Artifactory', description: 'Nexus Artifactory', service_type: PrismeService::NEXUS},
          props: [
              {key: PrismeService::NEXUS_REPOSITORY_URL, value: 'https://put-in-path-here:port/nexus/content/groups/everything/'},
              {key: PrismeService::NEXUS_PUBLICATION_URL, value: 'https://put-in-path-here:port/nexus/content/repositories/termdata/'},
      ...
      },
      {
          ...
          props: [
              {key: PrismeService::GIT_REPOSITORY_URL, value: 'https://put-in-path-here:port/git/r/repo_name.git'},
      ...
      },
      {
          ...
          props: [
              {key: PrismeService::JENKINS_ROOT, value: 'https://put-in-path-here:port'},
