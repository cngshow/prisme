  ...
  AITC_TEST = [
      {
          ...
          props: [
              ...
              {key: PrismeService::CARGO_REMOTE_URL, value: 'https://vaauscttdbs82.aac.va.gov:8080/manager'}
          ]
      },
      {
          service: {name: 'Nexus Artifactory', description: 'Nexus Artifactory', service_type: PrismeService::NEXUS},
          props: [
              {key: PrismeService::NEXUS_REPOSITORY_URL, value: 'https://vaauscttweb83.aac.va.gov:8443/nexus/content/groups/everything/'},
      ...
      },
      {
          ...
          props: [
              {key: PrismeService::GIT_REPOSITORY_URL, value: 'https://vaauscttdbs82.aac.va.gov:8080/git/r/repo_name.git'},
      ...
      },
      {
          ...
          props: [
              {key: PrismeService::JENKINS_ROOT, value: 'https://vaauscttweb83.aac.va.gov:8080'},
