 ...
 AITC_PROD = [
     {
         ...
         props: [
             ...
             {key: PrismeService::CARGO_REMOTE_URL, value: 'https://vaausappctt204.aac.va.gov:8080/manager'}
         ]
     },
         {
         ...
         props: [
             {key: PrismeService::CARGO_REMOTE_USERNAME, value: 'devtest'},
             {key: PrismeService::CARGO_REMOTE_PASSWORD, value: 'YTc-sZDZORkKjV8kjCommv4yp8fvYugnDy5xhr06XK1Ne4iYTMtPoAuhk4Qbwymwd_nktZ4e8jUjsYxoJjixiw=='},
             {key: PrismeService::CARGO_REMOTE_URL, value: 'https://vaausappctt205.aac.va.gov:8080/manager'}
         ]
     },
     {
         service: {name: 'Nexus Artifactory', description: 'Nexus Artifactory', service_type: PrismeService::NEXUS},
         props: [
             {key: PrismeService::NEXUS_REPOSITORY_URL, value: 'https://vaausappctt203.aac.va.gov:8443/nexus/content/groups/public'},
             {key: PrismeService::NEXUS_PUBLICATION_URL, value: 'https://vaausappctt203.aac.va.gov:8443/nexus/content/repositories/termdata/'},
     ...
     },
     {
         ...
         props: [
             {key: PrismeService::GIT_ROOT, value: 'https://vaausdbsctt202.aac.va.gov:8080/git/'},
     ...
     },
     {
         ...
         props: [
             {key: PrismeService::JENKINS_ROOT, value: 'https://vaausappctt203.aac.va.gov:8080/jenkins'},
